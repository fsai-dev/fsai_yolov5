...
class CometLogger:
    ...
    def download_dataset_artifact(self, artifact_path):
        ...
        if isinstance(metadata_names, dict):
            ...
            data_dict["names"] = {
                int(k): v for k, v in zip(range(len(metadata_names)), metadata_names)
            }
        else:
...
class CometClassifyLogger:
    ...
    def __init__(
        ...
        self.data_dict = self.check_dataset(os.path.join(self.opt.data, "dataset.yaml"))
        self.class_names = self.data_dict["names"]
        self.num_classes = self.data_dict["nc"]
    ...
    def check_dataset(self, data_file):
        ...
        self.log_asset(data_file, metadata={"type": "data-config-file"})
